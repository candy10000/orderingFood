...
//商家图片
    storeInfo: function () {
      var image = '../../image/'+this.integer(0,9)+".jpg"
      var name = "小"+this.ctitle(1, 3)+"的店"
      var grade = this.integer(1,5)
      var monthSell = this.integer(1000,10000)
      var time = this.integer(20,100)
      var distance = this.float(0,5,0,1)
      var comments = ['太好吃了吧！','分量超多，味道很棒','商家送的超快','包装很好，看起来很卫生','喜欢❤️']
      var data ={
        image:image,
        name:name,
        grade:grade,
        ...
        time: time,
        distance: distance,
        comment: comments[this.integer(0,4)]
      }
